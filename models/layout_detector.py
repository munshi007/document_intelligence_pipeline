...
class LayoutDetector:
    ...
    def __init__(self, debug_mode: bool = False):
        ...
        self.manual_config_path = str(Path(__file__).parent.parent / "weights" / "publaynet_config.yaml")
        self.manual_weights_path = str(Path(__file__).parent.parent / "weights" / "publaynet_weights.pkl")
