...
wandb_entity = "rohanmunshi06-otto-von-guericke-university-magdeburg" # Added based on your documentation
...
def format_data(examples):
    ...
    project_root = "/home/rmunshi/PROJECT/TEST/PROJECTS/pdf_pipeline copy"
...
# Verify and filter dataset if necessary (e.g. ensure images exist)
def filter_images(example):
    # The image path in dataset.jsonl is "research/dataset/images/..."
    # We need to find this relative to the project root
    project_root = "/home/rmunshi/PROJECT/TEST/PROJECTS/pdf_pipeline copy"
